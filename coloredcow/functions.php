    ...
    for ($i = 0; $i<3;$i++){
         ...
         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
             <div class="row">
                 ...
                 <div class="col-lg-8 col-md-10 col-sm-10 col-xs-10 btitled"><a href="<?php cc_root_path();?>/blogpost/?id=<?php  echo apply_filters('ID', $posts[$i]->ID);?>" class="btitle"><?php  echo apply_filters('the_title', $posts[$i]->post_title);?></a></div>
                 <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"></div></div>
                                                                  <div class="row">
                                                                   <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
                                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 auth">Abhishek Sharma</div>
                                                   <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
             </div>
