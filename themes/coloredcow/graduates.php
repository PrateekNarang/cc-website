...
<html lang="en">
  <head>
    ...
    <link href="<?php echo "$wp_path";?>/css/graduates.css" rel="stylesheet">
      <link rel="icon" 
      type="image/png" 
      href="<?php echo "$wp_path";?>/images/graduates/logo.png">
  </head>
  <body>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ye">
                     ...
                     <div class="col-lg-1 col-md-1 col-sm-2 col-xs-3">
                          <a href="<?php cc_home_path();?>"> <img src="<?php echo "$wp_path";?>/images/graduates/logo.png" height="65px" width="60px" style="padding-top:10px; padding-left:9px;"></a>
                      </div>
                 ...
                 <div class="row">
                      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu">
                         ...
                         <img src="<?php echo "$wp_path";?>/images/graduates/about_black.png" height="55px" width="65px" style=" top: 7px;position: absolute; top: 7px; left:6vw" > 
                          <div id="about">
                               <img src="<?php echo "$wp_path";?>/images/graduates/about.png" height="55px" width="65px" id="about1" />
                          </div>
                          </a>
</div>
                       <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu">
                     ...
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu">
                        <a href="#"> 
                         <img src="<?php echo "$wp_path";?>/images/graduates/edu_black.png" height="55px" width="65px" style=" top: 7px;position: absolute; top: 7px; left:6vw" > 
                              <div id="about">
                           <img src="<?php echo "$wp_path";?>/images/graduates/edu.png" height="55px" width="65px" id="edu">
                             </div>
                         </a>                        
                      </div>
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu">
                     ...
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu">
                        <a href="<?php cc_root_path();?>/career"> 
                         <img src="<?php echo "$wp_path";?>/images/graduates/career_black.png" height="60px" width="50px" style=" top: 7px;position: absolute; top: 7px; left:6vw" > 
                            <div id="about" onmouseover="myFunction1()" onmouseout="myFunction2()" >
                            <img src="<?php echo "$wp_path";?>/images/graduates/career.png" height="60px" width="50px" id="career" >              
                         </div>
                         </a>
                     </div>
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu">
                        <a href="<?php cc_root_path();?>/contact"> 
                         <img src="<?php echo "$wp_path";?>/images/graduates/contact_black.png" height="55px" width="50px" style=" top: 7px;position: absolute; top: 7px; left:6vw" > 
                            <div id="about">
                            <img src="<?php echo "$wp_path";?>/images/graduates/contact.png" height="55px" width="50px" id="contact">
                                  </div>
                         </a>
                     </div>
                    </div>
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 submenuspace">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 submenuspace">
                        ...
                        <div class="row" id="optional" style="display:none;" onmouseover="myFunction1()" onmouseout="myFunction2()">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 submenu">
                                <a href="#" class="subtext">Graduates</a>
                            </div>
                            <div class="hidden-lg hidden-md col-sm-1 col-xs-1">
