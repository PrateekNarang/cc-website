...
?>
    ...
    <head>
        ...
        <link rel="icon" type="image/png" href="<?php echo "$wp_path";?>/images/contact/logo.png">
    </head>
...
<div class="row" style="padding-top: 10px; padding-right: 5px;">
                ...
                <div class="row">
                    ...
                    <div class="row" >
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 hidden-xs menuname" >
                                <a href="#" class="headertext">  <center><p id="contactlist" style="padding-right:33px;">Contact</p> </center>                                     </a>
                            </div>
                    </div>
