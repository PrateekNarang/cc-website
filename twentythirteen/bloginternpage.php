...
Comment is entered
 */
$wp_path = 'http://localhost/wordpress/wp-content/themes/twentythirteen';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="<?php echo "$wp_path";?>/images/one.jpg"/>
    ...
    <script src="<?php echo "$wp_path";?>/js/bootstrap.min.js"></script>
       <div class="container">
             <div class="row">
                  ...
                  <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12 ccf" >
                  <div class="cc">
                     Colored Cow
                  </div>
              </div>
           ...
           <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-1 col-xs-1 ile">
                  </div>
                  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 ill">
                      <hr >
                  </div>
               <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 ilf" >
                  <div class="il">
                     Intern Lounge
                  </div>
              </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sp">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 low">
                            <hr>
                  </div>
               <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 low" >
                  <div class="oi">
                     OUR INTERNS
                  </div>
              </div>
